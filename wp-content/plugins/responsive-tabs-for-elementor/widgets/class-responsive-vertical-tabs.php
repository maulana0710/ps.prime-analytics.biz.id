<?php
/**
 * Responsive_Vertical_Tabs class.
 *
 * @category   Class
 ...
 * @since 6.0.0
 */
class Responsive_Vertical_Tabs extends Widget_Base
{
  /**
  ...
  public function __construct($data = [], $args = null)
  {
    ...
    wp_register_style('responsive-vertical-tabs', plugins_url('/assets/css/responsive-vertical-tabs.min.css', RESPONSIVE_TABS_FOR_ELEMENTOR), [], '6.0.0');
    ...
    if (get_plugin_data(ELEMENTOR__FILE__)['Version'] >= "3.5.0") {
      wp_register_script('responsive-tabs', plugins_url('/assets/js/responsive-tabs-widget-handler.min.js', RESPONSIVE_TABS_FOR_ELEMENTOR), ['elementor-frontend'], '6.0.0', true);
    } else {
      wp_register_script('responsive-tabs', plugins_url('/assets/js/responsive-tabs-widget-old-elementor-handler.min.js', RESPONSIVE_TABS_FOR_ELEMENTOR), ['elementor-frontend'], '6.0.0', true);
    }
  }
  ...
  {
    return 'responsive-vertical-tabs';
  }
  ...
  {
    return __('Responsive Vertical Tabs', 'responsive-tabs-for-elementor');
  }
  ...
  {
    $styles = ['responsive-vertical-tabs'];
  ...
  protected function _register_controls()
  {
    ...
    $this->add_responsive_control(
        ...
        [
            ...
            'selectors' => [
                '{{WRAPPER}} .vertical-tabs-section .vertical-tab' => 'flex-direction: {{VALUE}}',
            ],
            'classes'   => 'tab-direction-control',
        ]
    );

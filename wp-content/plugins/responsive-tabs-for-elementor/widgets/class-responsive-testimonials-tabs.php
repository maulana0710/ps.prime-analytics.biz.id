...
class Responsive_Testimonials_Tabs extends Widget_Base
{
    ...
    public function __construct($data = [], $args = null)
    {
        ...
        wp_register_style('responsive-testimonials-tabs', plugins_url('/assets/css/responsive-testimonials-tabs.min.css', RESPONSIVE_TABS_FOR_ELEMENTOR), [], '6.0.0');
    ...
    protected function render()
    {
        ...
        if ($settings['tab']) { ?>
            ...
            <section class="testimonials-tabs">
                <div class="cards">

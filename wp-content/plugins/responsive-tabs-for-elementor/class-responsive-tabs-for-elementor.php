...
final class Responsive_Tabs_For_Elementor
{
  ...
  public function init()
  {
    ...
    add_action('elementor/editor/after_enqueue_scripts', [$this, 'vertical_tabs_handler']);
  }
  ...
  public function vertical_tabs_handler()
  {
    wp_enqueue_script('responsive-vertical-tabs-handler', plugins_url('/assets/js/responsive-vertical-tabs-handler.min.js', RESPONSIVE_TABS_FOR_ELEMENTOR), [], '6.0.0', false);
  }
}
